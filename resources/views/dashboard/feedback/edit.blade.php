    ...
    <div class="container form-container">
        ...
        <form action="{{ route('feedback.update', $feedback->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="date" name="created_at" id="created_at" class="form-control">{{ $feedback->created_at }}
            </div>
            <div class="form-group">
...
{{--                    <input class="form-check-input" type="radio" name="status" id="statusActive" value="1" @if($feedback->status) checked @endif>--}}
